    ...
    <section id="start" className="dark relative overflow-hidden">
      <div className="shell grid gap-14 py-24 md:py-32 lg:grid-cols-12 lg:gap-14">
        <div className="lg:col-span-5">
          ...
          <Reveal delay={0.25}>
            <div className="mt-10"><Figure src={photos.phone} alt="" ratio="16 / 10" wipe="x" /></div>
          </Reveal>
          <Reveal delay={0.3}>
            <div className="mt-8 space-y-3 border-t border-line pt-7">
              <a href={`tel:${site.phoneRaw}`} className="block"><p className="eyebrow !text-fg-3">Or call, 24 hours</p><p className="figure link-draw mt-2 w-fit text-[clamp(1.75rem,3.5vw,2.5rem)] text-accent">{site.phone}</p></a>
