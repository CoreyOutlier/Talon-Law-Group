...
export default function Privacy() {
  return (
    <>
      ...
      <section className="shell max-w-[70ch] space-y-6 pb-28 text-[15px] leading-relaxed text-fg/70">
        ...
        <p>
          ...
          <a href={`mailto:${site.email}`} className="text-accent link-draw">{site.email}</a>.
        </p>
      </section>
    </>
  );
