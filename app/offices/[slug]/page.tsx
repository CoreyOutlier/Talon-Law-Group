    ...
    <>
      ...
      <section className="shell pb-20 md:pb-28">
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.15}>
              <div className="mt-16 border-t border-line pt-10">
                ...
                <p className="mb-8 max-w-[56ch] text-[14px] leading-relaxed text-fg-3">
            ...
            <Reveal delay={0.2}>
              <div className="mt-14 border-t border-line pt-10">
                ...
                <ul className="space-y-3">
                  {m.courts.map((c) => (
                    <li key={c} className="flex gap-4 text-[15px] text-fg/75">
            ...
            <Reveal delay={0.25}>
              <div className="mt-14 border-t border-line pt-10">
                ...
                <p className="max-w-[62ch] text-[15px] leading-relaxed text-fg/70">
                  {m.areas.join(", ")}.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <div className="lg:sticky lg:top-28">
                <div className="border border-line p-7">
                  ...
                  {m.address ? (
                    <address className="not-italic text-[15px] leading-relaxed text-fg/85">
                      {m.address.street}
                      <br />
                  ...
                  <p className="mt-5 text-[12px] leading-relaxed text-fg-3">{site.hours}</p>
                </div>
                    ...
                    {practiceAreas.slice(0, 6).map((p) => (
                      <li key={p.slug}>
                        <Link
                          ...
                          className="link-draw text-[14px] text-fg/70"
                        >
                          {p.short}
                        </Link>
                      </li>
        ...
        <Reveal delay={0.15}>
          ...
          >
            <span>
              <span className="eyebrow !text-fg-3">Next office</span>
