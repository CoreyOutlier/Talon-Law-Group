      ...
      <section className="shell pb-20 md:pb-28">
        <Reveal>
          <div className="mb-16 flex flex-wrap items-center gap-4 border-y border-hairline py-5">
            <span className="h-1.5 w-1.5 rotate-45 bg-brass" aria-hidden />
            <p className="text-[13px] uppercase tracking-[0.14em] text-brass">{area.urgency}</p>
          </div>
        </Reveal>
                  ...
                  <dl className="divide-y divide-hairline border-y border-hairline">
                    {area.faqs.map((f) => (
                      <div key={f.q} className="py-7">
                        <dt className="display text-[1.25rem] leading-snug text-bone">{f.q}</dt>
                        <dd className="mt-3 max-w-[62ch] text-[15px] leading-relaxed text-bone/65">
                          {f.a}
                        </dd>
                      </div>
                    ))}
        ...
        <Reveal delay={0.2}>
          ...
          >
            <span>
              <span className="eyebrow !text-slate-2">Next</span>
